    ...
    <form role="form" method="POST" action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data">
      ...
      <div class="card-body">
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
              <div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title_tm" id="title_tm" value="{{ $post->title_tm }}" placeholder="Täzeligiň sözbaşysy">
                </div>
        
                <div class="form-group">
                  <label for="description_tm">Habaryň türkmençesi</label>
                  <textarea name="text_tm" class="form-control summernote" id="text_tm">{{ $post->text_tm }}</textarea>
                </div>
              </div>
              <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                ...
                <div class="form-group">
                  ...
                  <textarea name="text_ru" class="form-control summernote" id="text_ru">{{ $post->text_ru }}</textarea>
                </div>
              </div>
              <div class="tab-pane fade" id="custom-tabs-one-messages" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">
                ...
                <div class="form-group">
                  ...
                  <textarea name="text_en" class="form-control summernote" id="text_en">{{ $post->text_en }}</textarea>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="form-group">
          ...
          <input id="input-id" type="file" name="poster" class="form-control" id="exampleInputEmail1" value="{{ $post->poster }}">
